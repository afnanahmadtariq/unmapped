...
export class ItuDigitalHarvester extends BaseHarvester {
  ...
  private readonly indicators = [
    ...
    { id: 'IT.NET.BBND.P2', name: 'Fixed broadband subscriptions (per 100 people)' },
    { id: 'IT.MLT.MAIN.P2', name: 'Fixed telephone subscriptions (per 100 people)' },
    { id: 'IT.NET.SECR.P6', name: 'Secure Internet servers (per 1 million people)' },
  ];
